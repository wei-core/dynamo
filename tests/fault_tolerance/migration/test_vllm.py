...
# TODO: Restore @pytest.mark.nightly after this restored KV-transfer matrix passes
# pre-merge CI qualification without retries.
@pytest.mark.pre_merge
...
@pytest.mark.timeout(350)  # 3x average
# TODO: Restore @pytest.mark.nightly after this restored decode matrix passes
# pre-merge CI qualification without retries.
@pytest.mark.pre_merge
